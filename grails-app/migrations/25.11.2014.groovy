databaseChangeLog = {
    ...
    changeSet(author: "cyrusmith (generated)", id: "1416932887612-1") {
    ...
    changeSet(author: "cyrusmith (generated)", id: "1416932887612-2") {
    ...
    changeSet(author: "cyrusmith (generated)", id: "1416932887612-3") {
        dropForeignKeyConstraint(baseTableName: "charge", baseTableSchemaName: "dropbike", constraintName: "FK_9pfivyijy30fny2qnw1gta91c")
    }

    changeSet(author: "cyrusmith (generated)", id: "1416932887612-4") {
        dropForeignKeyConstraint(baseTableName: "charge", baseTableSchemaName: "dropbike", constraintName: "FK_rf4luejj74eh02aan6lsfh8a6")
    }

    changeSet(author: "cyrusmith (generated)", id: "1416932887612-7") {
        createIndex(indexName: "FK_h6dr47em6vg85yuwt4e2roca4", tableName: "account") {
            column(name: "user_id")
        }
    }

    changeSet(author: "cyrusmith (generated)", id: "1416932887612-8") {
        createIndex(indexName: "user_id_uniq_1416932887245", tableName: "account", unique: "true") {
            column(name: "user_id")
        }
    }

    changeSet(author: "cyrusmith (generated)", id: "1416932887612-9") {
        createIndex(indexName: "FK_cwjmw3oq5fhkceahr96k1xh3n", tableName: "operation") {
            column(name: "account_id")
        }
    }

    changeSet(author: "cyrusmith (generated)", id: "1416932887612-10") {
        dropTable(tableName: "charge")
    }

    changeSet(author: "cyrusmith (generated)", id: "1416932887612-5") {
    ...
    changeSet(author: "cyrusmith (generated)", id: "1416932887612-6") {
