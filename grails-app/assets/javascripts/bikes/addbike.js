(function(scope) {
	...
	scope.dropbyke.ui.LocationSelector = Backbone.View
			.extend({
				...
				events : {
					"click #mapModal .apply-location" : "applyLocation",
					"shown.bs.modal #mapModal" : "modalShown"
				},

				initialize : function() {
					this.modal = this.$('#mapModal');
					this.mapContainer = this.$('#mapModal .modal-body');
					this.lat = this.$('input[name="lat"]');
					this.lon = this.$('input[name="lon"]');
					this.latLon = null;
				},
